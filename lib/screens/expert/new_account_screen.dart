...
class _NewAccountScreenState extends State<NewAccountScreen> {
  ...
  InputValidation _accountNameValidation =
      InputValidation(isValid: true, message: '');
  InputValidation _accountNumberValidation =
      InputValidation(isValid: true, message: '');
  InputValidation _educationValidation =
      InputValidation(isValid: true, message: '');
  InputValidation _jobValidation = InputValidation(isValid: true, message: '');
  InputValidation _identityCardValidation =
      InputValidation(isValid: true, message: '');
  String _bank = "BCA";
  String? _image = "";
  XFile? _file;
  ...
  Widget build(BuildContext context) {
    ...
    final Color _borderColor =
        _preferencesProvider.isDarkTheme ? Colors.white : Colors.black;
              ...
              onPressed: () async {
                ...
                if (_accountNameValidation.isValid &&
                  ...
                  try {
                    ...
                    await UserModel.getUserByEmail(_provider.user!.email)
                        .then((value) {
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                  items: ['BCA', 'BNI', 'BRI', 'MANDIRI', 'PERMATA']
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: _fontColor),
                    errorText:
                        _jobValidation.isValid ? null : _jobValidation.message),
              ),
              const SizedBox(
                height: 15,
              ),
