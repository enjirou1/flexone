...
class ConsultationReviewScreen extends StatefulWidget {
  ...
  ConsultationReviewScreen({ Key? key, required this.consultationId }) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder<List<Review>>(
          future: Consultation.getConsultationReviews(widget.consultationId, _reviews.length, 20),
