  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('create_room').tr(),
        actions: [
          IconButton(
            onPressed: () async {
              bool isValid = true;
              ...
              if (isValid) {
                await Room.createNewRoom(_provider.user!.userId!, _nameController.text, _image!, _descriptionController.text, _passwordController.text, _slotController.text);
