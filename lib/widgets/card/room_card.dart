...
import 'package:flexone/screens/room/detail_room_screen.dart';
...
class RoomCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        final joined = await Room.checkJoin(room.id, _provider.user!.userId!);
        _roomProvider.setRoom(room);
        Get.to(DetailRoomScreen(joined: joined));
      },
      child: Column(
